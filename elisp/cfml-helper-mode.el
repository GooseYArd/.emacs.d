...
(defvar cfml-helper-htmldtd-version "<!DOCTYPE HTML PUBLIC \"-//IETF//DTD
HTML//EN\">\n"
...
;; then cfml-helper-rebuild-menu. See the mode documentation for more
;; detail.
...
(mapcar 'cfml-helper-add-type-to-alist
  '((entity  . (nil nil cfml-helper-entity-menu "Insert Character
Entities"))
...
`(cfml-helper-add-tag '(type keybinding completion-tag menu-name template
doc)'"
  (let* ((type (car l))
...
(defun cfml-helper-indent ()
 ...
 (if (looking-at cfml-helper-any-list)
  ...
  ;;
  ;; fixing indentation
  ;;  (setq newi (- newi cfml-helper-basic-offset cfml-helper-item-continue-indent)))
  (setq newi (- newi cfml-helper-basic-offset)))
